...
<script defer src="{{ asset('js/rolForm.js') }}"></script>
...
<div class="row">
    ...
    <h3 class="col-sm-11 container-title text-center text-sm-start text-white m-0 p-2">Crear Trabajador</h3>
</div>
...
<div class="container mt-4">
    ...
    <form action="{{ route('trabajadores.create') }}" method="post" class="row g-3 px-5 py-3">
        @csrf
        ...
        <div class="mb-3 col-md-12">
            <label for="salario" class="form-label">Rol</label>
            <select class="form-select bg-dark text-white" name="rol" id="rolSelect" aria-label="Seleccionar rol trabajador" required>
        ...
        <div class="col-12 mt-3">
            <div id="variableInputsContainer" class="row">
