...
<div class="row">
    ...
    <h3 class="col-sm-11 container-title text-center text-sm-start text-white m-0 p-2">
        {{ $gerente->trabajador->persona->nombre }} {{ $gerente->trabajador->persona->apellidos }}
    </h3>
</div>
...
<div class="container mt-4">
    <div class="row g-3 px-5 py-3">
        <div class="mb-3 col-md-5">
            ...
            <input type="text" class="form-control bg-dark text-white" name="nombre" id="nombre" value="{{ $gerente->trabajador->persona->nombre }}" required disabled>
        </div>
        <div class="mb-3 col-md-5">
            <label for="apellidos" class="form-label">Apellidos</label>
            <input type="text" class="form-control bg-dark text-white" name="apellidos" id="apellidos" value="{{ $gerente->trabajador->persona->apellidos }}" required disabled>
        </div>

        <div class="mb-3 col-md-2">
            <label for="edad" class="form-label">Edad</label>
            <input type="text" class="form-control bg-dark text-white" name="edad" id="edad" value="{{ $gerente->trabajador->persona->edad }}" required disabled>
        </div>
        ...
        <div class="mb-3 col-md-12">
            ...
            <input type="text" step="any" class="form-control bg-dark text-white" name="salario" id="salario" value="{{ $gerente->salario }}" required disabled>
        </div>

        <div class="mb-3 col-md-6">
            <label for="sueldo" class="form-label">Sueldo</label>
            <input type="text" step="any" class="form-control bg-dark text-white" name="sueldo" id="sueldo" value="{{ $gerente->calcularSueldo() }}" required disabled>
        </div>
